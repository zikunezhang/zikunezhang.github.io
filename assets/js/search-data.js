...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "post-a-modified-poincaré-inequality-in-discrete-settings",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%7A%7A%33%33%36%37@%63%6F%6C%75%6D%62%69%61.%65%64%75", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/zkzhang03", "_blank");
        },
      },{
      id: 'light-theme',
