...
={}&\frac{1}{2S}\sum_{x,y=1}^S \mu(x)(\epsilon(\sqrt{f(x)}-\sqrt{f(y)}))(\log(1+\epsilon\sqrt{f(x)})-\log(1+\epsilon\sqrt{f(y)}))\notag\\
={}&\frac{1}{2S}\sum_{x,y=1}^S \mu(x)\epsilon(\sqrt{f(x)}-\sqrt{f(y)})(\epsilon\xi_\epsilon(x,y)(\sqrt{f(x)}-\sqrt{f(y)}))\notag\\
={}&\epsilon^2\cdot\frac{1}{2S}\sum_{x,y=1}^S \mu(x)(\sqrt{f(x)}-\sqrt{f(y)})^2\xi_\epsilon(x,y)\notag\\
\leq{}&\frac{\epsilon^2}{4}\frac{1}{2S}\sum_{x,y=1}^S \mu(x)(f(x)-f(y))(\log f(x)-\log f(y))\xi_\epsilon(x,y),\label{dirichlet}
\end{align}
